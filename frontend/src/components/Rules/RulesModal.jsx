...
const CONTENIDO = {
  ...
  cantos: {
    ...
    texto: [
      ...
      "Escalada de envido: Envido → Envido (acumula) → Real Envido → Falta Envido.",
      ...
      "FLOR (si está habilitada en la mesa): se canta cuando un jugador tiene 3 cartas del mismo palo.",
    ],
  },
};
